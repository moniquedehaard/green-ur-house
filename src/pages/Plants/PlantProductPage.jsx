...
export default class PlantProductPage extends Component {
  ...
  handleClick = (event) => {
    ...
    if (user) {
      ...
      const fav = user.favoritePlants.find(
        (el) => el === this.props.match.params.id
      )
        ? true
        : false;
  ...
  handleClickHomePlant = (event) => {
    ...
    if (user) {
      ...
      const home = user.homePlants.find(
        (el) => el.species === this.props.match.params.id
      )
        ? true
        : false;
      ...
      if (home) {
        ...
        const numberOfPlants = user.homePlants.filter(
          (el) => el.species === this.props.match.params.id
        );
        ...
        if (numberOfPlants.length > 1) {
          ...
          this.props.history.push(
            `/your-plants/delete/${numberOfPlants[0]._id}`
          );
        }
      }
      ...
      if (!home) {
        ...
        this.props.history.push({
          pathname: "/your-plants/create",
          plant: this.state.plant.latinName,
        });
      }
    }
  };
  ...
  updateButtons(plantId) {
    ...
    const fav = this.props.user.favoritePlants.find((el) => el === plantId)
      ? true
      : false;
    const home = this.state.user.homePlants.find((el) => el.species === plantId)
      ? true
      : false;
    return {
      hasFavPlant: fav,
          ...
          <div className="ppp_information">
            ...
            <div className="ppp_properties_block">
              ...
              <div className="ppp_property">
                ...
                {plant.strongAirPurifier ? (
                  <p> strong air purifier</p>
                ) : (
                  <p> medium/low air purifier</p>
                )}
              </div>
              ...
              <div className="ppp_property">
                ...
                {plant.toxicForPets ? (
                  <p> not safe for your pets</p>
                ) : (
                  <p> safe for your pet</p>
                )}
              </div>
            </div>
            ...
            <div className="ppp_buttons">
              {/* Favorite plant */}
              {(user &&
                ((buttonValues.hasFavPlant && (
                  <button
                    onClick={this.handleClick}
                    className="btn_round"
                    style={{
                      marginTop: "20px",
                      backgroundColor: "rgb(170,138,75)",
                    }}
                  >
                    {" "}
              ...
              {(user &&
                ((buttonValues.hasHousePlant && (
                  <button
                    onClick={this.handleClickHomePlant}
                    className="btn_round"
                    style={{
                      marginTop: "20px",
                      backgroundColor: "rgb(170,138,75)",
