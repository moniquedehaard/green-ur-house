                ...
                <div className="homepage_left">
                    ...
                    <div className="form">
                        ...
                        <form className="plant_form"  onSubmit={this.handleSubmit}>
                            ...
                            <br/>
                            <select className="select_form"  id="room" name="room" value={this.state.room} onChange={this.handleChange}>
                            ...
                            <div className="formPlant_buttons">
                                ...
                                <button className="btn_gb" onClick={this.handleClick} > Do this later </button>
                            </div>
